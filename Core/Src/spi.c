...
void HAL_SPI_MspInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = LCD_HWCS_Pin|LCD_SCK_Pin|LCD_MOSI_Pin;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* spiHandle)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, LCD_HWCS_Pin|LCD_SCK_Pin|LCD_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, MEMS_SCK_Pin|MEMS_MISO_Pin|MEMS_MOSI_Pin);
